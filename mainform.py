...
#
# Created: Fri Dec  5 17:25:15 2014
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icons/icons/Actions-list-add-user-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_works_add_soloist.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icons/icons/Actions-application-exit-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionUkoncit.setIcon(icon7)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icons/icons/Actions-document-edit-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionUpravit.setIcon(icon8)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icons/icons/Places-folder-sound-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSprava_festivalov.setIcon(icon9)
